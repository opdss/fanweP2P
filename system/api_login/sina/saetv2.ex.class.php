...
class SaeTOAuthV2 {
	...
	function getAccessToken( $type = 'code', $keys ) {
		...
		$response = $this->oAuthRequest($this->accessTokenURL().$params_str, 'POST', $params);
	...
	return $this->http2($url,$parameters,$method,$multi);
...
/**
     ...
     * @return string
     */
    public  function http2( $url , $params = array(), $method = 'GET' , $multi = false, $extheaders = array())
    {
